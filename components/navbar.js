    ...
    render() {
        this.shadowRoot.innerHTML = `
            <style>
                ...
                :host { display: block; position: fixed; top: 0; left: 0; right: 0; z-index: 1000; background: rgba(7, 21, 33, 0.78); backdrop-filter: blur(12px); border-bottom: 1px solid rgba(125, 211, 252, 0.12); transition: all 0.3s ease; }
                /* Scrolled state - darker background with shadow */
                :host(.scrolled) { background: rgba(7, 21, 33, 0.94); box-shadow: 0 10px 30px rgba(0, 0, 0, 0.3); }
            ...
            <nav>
                ...
                <a href="#hero" class="logo">
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <defs><linearGradient id="logo-gradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#38bdf8"/><stop offset="100%" style="stop-color:#2dd4bf"/></linearGradient></defs>
